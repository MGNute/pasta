...
class PastaUserSettings(UserSettingsContainer):
    def __init__(self):
        ...
        self.baliphyalign = UserSettingGroup('baliphyalign') #this has to be the second argument of the __init__
        self._categories.append('baliphyalign')
        ...
        self.qinsi_mafft = UserSettingGroup('qinsi_mafft')
        self._categories.append('qinsi_mafft')
        ...
        self.qinsi_mafft.add_option('path', StringUserSetting(name='path', default='', short_name=None, help='Path to MAFFT Qinsi executables', subcategory=None))
        self.qinsi_mafft.add_option('args', StringUserSetting(name='args', default='', short_name=None, help='Arguments to be passed to Mafft-QinsI.', subcategory=None))
        ...
        self.baliphyalign.add_option('path', StringUserSetting(name='path', default='', short_name=None, help='Path to baliphyalign script', subcategory=None))
        self.baliphyalign.add_option('time_limit', StringUserSetting(name='time_limit', default='12', short_name=None, help='Amount of time BAli-Phy should be run for during a single PASTA iteration', subcategory=None))
        self.baliphyalign.add_option('args', StringUserSetting(name='args', default='', short_name=None, help='Arguments to be passed to BAli-Phy.', subcategory=None))
        ...
        #for the interuptable version:
        self.commandline.add_option('interruptible', BoolUserSetting(name='interruptible', default='False', short_name=None, help='If used, PASTA will not finish. Instead it will save its state and terminate once it reaches the alignment stage, outputting a list of paths to fasta files which must be aligned by the user, along with their eventual target paths.', subcategory=None))
        self.commandline.add_option('resume_state_path', StringUserSetting(name='resume_state_path', default=None, short_name=None, help='Path to the file containing the pasta state when it was interupted. If \'--interuptable\' is True, then this option should be provided only if the file is ready to be resumed from.', subcategory=None))